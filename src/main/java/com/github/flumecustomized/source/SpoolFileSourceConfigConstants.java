 ...
 */
public class SpoolFileSourceConfigConstants {
    ...
    public static final String TARGET_YOUNGEST_FILENAME       = "targetYoungestFileName";
    public static final String DEFAULT_TARGET_YUNEST_FILENAME = "";
