 ...
 */
public class ReliableSpoolFileEventReader implements ReliableEventReader {
     ...
     */
    private ReliableSpoolFileEventReader(File spoolDirectory,
                                         String completedSuffix,
                                         String ignorePattern,
                                         String targetPattern,
                                         String targetYoungestFileName,
        ...
        Preconditions.checkNotNull(targetYoungestFileName);
        ...
        this.targetYoungestFileName = targetYoungestFileName;
        ...
        logger.info("target youngest file name is : " + this.targetYoungestFileName);
    ...
    public List<Event> readEvents(int numEvents) throws IOException {
        ...
        if (events.isEmpty()) {
            ...
            if (logger.isDebugEnabled()) {
                logger.debug("-------------------split line start-------------------");
                logger.debug("-=-=-=-=-=-=-=-=-=-= is target file : " + isTargetFile);
                logger.debug("-=-=-=-=-=-=-=-=-=-= is youngest file : " + isYoungestFile);
                logger.debug("-=-=-=-=-=-=-=-=-=-= is exist next file : " + isExistNextFile);
                logger.debug("-------------------split line end-------------------");
            }
            ...
            if (!isTargetFile               //	Only CurrentFile is no longer the target, at the meanwhile, next file exists.
                ...
                currentFile = getNextFile();
            } else if (isYoungestFile && isExistNextFile) {
                logger.info("got youngest file and there is more than one log file !");

                //got non-target file
                currentFile = getNextFile();
                //delete non-target file
                retireCurrentFile();
                //return back to really target file
                currentFile = getNextFile();
            }
    ...
    private Optional<FileInfo> getNextFile() {
        ...
        if (consumeOrder == ConsumeOrder.RANDOM) {    // Selected file is random.
            logger.error("unsupported Options : RANDOM");
            throw new UnsupportedOperationException("unsupported Options : RANDOM");
//            return openFile(selectedFile);
    ...
    public static class Builder {
        ...
        private String            targetYoungestFileName = DEFAULT_TARGET_YUNEST_FILENAME;
        ...
        public Builder targetYoungestFileName(String targetYoungestFileName) {
            this.targetYoungestFileName = targetYoungestFileName;
            return this;
        }
